...
static PyCodeObject *codeobj_be6b352426ef6ee9735ad87c95a9a1db;
/* For use in "MainProgram.c". */
PyCodeObject *codeobj_main = NULL;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[22]; CHECK_OBJECT(module_filename_obj);
    codeobj_be6b352426ef6ee9735ad87c95a9a1db = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[31], NULL, NULL, 0, 0, 0);
}
...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$function__4_complex_call_helper_keywords_star_list_star_dict(PyObject **python_pars);
...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$function__1__mro_entries_conversion(PyObject **python_pars) {
    ...
    branch_no_1:;
    {
        ...
        tmp_result = HAS_ATTR_BOOL(tmp_expression_name_1, mod_consts[10]);
...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$function__4_complex_call_helper_keywords_star_list_star_dict(PyObject **python_pars) {
    ...
    branch_yes_6:;
    {
        ...
        tmp_result = HAS_ATTR_BOOL(tmp_expression_name_5, mod_consts[1]);
        tmp_or_left_value_1 = (tmp_result) ? NUITKA_BOOL_TRUE : NUITKA_BOOL_FALSE;
        tmp_or_left_truth_1 = tmp_or_left_value_1 == NUITKA_BOOL_TRUE ? 1 : 0;
        if (tmp_or_left_truth_1 == -1) {
            assert(ERROR_OCCURRED());
        ...
        tmp_result = HAS_ATTR_BOOL(tmp_expression_name_6, mod_consts[2]);
        tmp_or_right_value_1 = (tmp_result) ? NUITKA_BOOL_TRUE : NUITKA_BOOL_FALSE;
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_be6b352426ef6ee9735ad87c95a9a1db;
    ...
    // Module code.
    // Frame without reuse.
    frame_be6b352426ef6ee9735ad87c95a9a1db = MAKE_MODULE_FRAME(codeobj_be6b352426ef6ee9735ad87c95a9a1db, module___main__);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_be6b352426ef6ee9735ad87c95a9a1db);
    assert(Py_REFCNT(frame_be6b352426ef6ee9735ad87c95a9a1db) == 2);
    ...
    // Framed code:
    {
        ...
        frame_be6b352426ef6ee9735ad87c95a9a1db->m_frame.f_lineno = 1;
    ...
    // Tried code:
    {
        ...
        frame_be6b352426ef6ee9735ad87c95a9a1db->m_frame.f_lineno = 2;
    ...
    if (exception_keeper_tb_1 == NULL) {
        exception_keeper_tb_1 = MAKE_TRACEBACK(frame_be6b352426ef6ee9735ad87c95a9a1db, exception_keeper_lineno_1);
    } else if (exception_keeper_lineno_1 != 0) {
        exception_keeper_tb_1 = ADD_TRACEBACK(exception_keeper_tb_1, frame_be6b352426ef6ee9735ad87c95a9a1db, exception_keeper_lineno_1);
    }
    ...
    branch_yes_1:;
    {
        ...
        frame_be6b352426ef6ee9735ad87c95a9a1db->m_frame.f_lineno = 5;
    ...
    }
    {
        ...
        frame_be6b352426ef6ee9735ad87c95a9a1db->m_frame.f_lineno = 7;
        tmp_call_result_1 = CALL_FUNCTION_WITH_SINGLE_ARG(tmp_called_name_1, mod_consts[30]);
    ...
    }
    {
        ...
        frame_be6b352426ef6ee9735ad87c95a9a1db->m_frame.f_lineno = 8;
    ...
    if (exception_tb && exception_tb->tb_frame == &frame_be6b352426ef6ee9735ad87c95a9a1db->m_frame) frame_be6b352426ef6ee9735ad87c95a9a1db->m_frame.f_lineno = exception_tb->tb_lineno;
    ...
    try_end_1:;
    {
        ...
        frame_be6b352426ef6ee9735ad87c95a9a1db->m_frame.f_lineno = 11;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_be6b352426ef6ee9735ad87c95a9a1db);
#endif
    popFrameStack();

    assertFrameObject(frame_be6b352426ef6ee9735ad87c95a9a1db);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_be6b352426ef6ee9735ad87c95a9a1db, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_be6b352426ef6ee9735ad87c95a9a1db->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_be6b352426ef6ee9735ad87c95a9a1db, exception_lineno);
    }
